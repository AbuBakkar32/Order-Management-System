<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Project.Registration" %>
        ...
        <div class="sec2">
            <div class="container">
                <div class="content">
                    ...
                    <h2 id="ogin"><span class="login">E</span><span class="ogin">mployee</span>&nbsp<span class="login">L</span><span class="ogin">ogin</span></h2>
