<%@ Page Title="" Language="C#" MasterPageFile="~/MasterCustomer.Master" AutoEventWireup="true" CodeBehind="HomeCustomer.aspx.cs" Inherits="Project.HomeCustomer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <link href="CSS/homeCustomer.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="section">
     ...
     <div class="visib"><asp:Label ID="Label15" Class="textvisible" runat="server" >Order History</asp:Label></div> 
    <%--<div class="inputbox">
        <table>
            <tr>
     ...
     <div>
         <asp:Button ID="Button1" Class="customerlist" runat="server" Text="View All Available Product" OnClick="Button1_Click" />
     </div>
    <div class="gridview">
        <asp:GridView ID="GridView1" class="grid" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDeleting="GridView1_RowDeleting" >
    ...
    <div class="visib1"><asp:Label ID="Label8" Class="textvisible1" runat="server" Visible="false" >Available Product</asp:Label></div> 
 <div class="gridview1">

        <asp:gridview ID="GridView2" class="grid1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>
