<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Homex.aspx.cs" Inherits="Project.Homex" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <marquee direction="" width="1000px" behavior="alternate" SCROLLDELAY=100 >
            <h3 style="font-size:30px; color:whitesmoke;">Welcome to Employee Portal</h3></marquee>
     <div class="date"> 
