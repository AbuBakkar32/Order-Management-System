...
namespace Project
{
    public partial class Homex : System.Web.UI.Page
    {
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Label cphone = gr.FindControl("Label3") as Label;
            Label caddress = gr.FindControl("Label2") as Label;
            ...
            caddress.Text = cphone.Text;
            Cphone.Text = caddress.Text;
